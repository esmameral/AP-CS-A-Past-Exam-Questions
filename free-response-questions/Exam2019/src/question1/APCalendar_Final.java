...
public class APCalendar_Final {
	public static void main(String[] args) {
		
		System.out.println(dayOfWeek(1, 25, 2022));
	...
	private static int firstDayOfYear(int year) { 
		...
		return calender.get(Calendar.DAY_OF_WEEK)%7;
	}
	...
	public static int dayOfWeek(int month, int day, int year) { 
		...
		int total = firstDayOfYear + dayOfYear - 1;
